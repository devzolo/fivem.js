...
export class RelationshipGroup {
   ...
   */
  public setRelationshipBetweenGroups(targetGroup: RelationshipGroup, relationship: Relationship, biDirectionally = false): void {
   ...
   */
  public clearRelationshipBetweenGroups(targetGroup: RelationshipGroup, relationship: Relationship, biDirectionally = false): void {
