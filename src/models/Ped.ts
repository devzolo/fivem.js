...
export class Ped extends Entity {
  ...
  public get SelectedWeapon(): number {
    return GetSelectedPedWeapon(this.handle);
  }

  public getAmmoInWeapon(weaponHash: WeaponHash): number {
    return GetAmmoInPedWeapon(this.handle, weaponHash);
  }

  public getAmmoInClip(weaponHash: WeaponHash, ammo: number): number {
  ...
  public getKiller(): Entity {
    return Entity.fromHandle(GetPedSourceOfDeath(this.handle)) as Entity;
  }
  ...
  public playAmbientSpeed(speechName: string, voiceName = '', modifier: SpeechModifier = SpeechModifier.Standard): void {
