...
export class Entity {
  public static fromHandle(handle: number): Ped | Vehicle | Prop | undefined {
  ...
  public static fromNetworkId(networkId: number): Ped | Vehicle | Prop | undefined {
  ...
  public get AttachedBlip(): Blip | undefined {
  ...
  public getEntityAttachedTo(): Entity | undefined {
  ...
  public applyForceRelative(direction: Vector3, rotation: Vector3, forceType: ForceType = ForceType.MaxForceRot2): void {
    ApplyForceToEntity(
      this.handle,
      Number(forceType),
      direction.x,
