...
export declare class Ped extends Entity {
    ...
    get LastVehicle(): Vehicle | undefined;
    get VehicleTryingToEnter(): Vehicle | undefined;
    ...
    getAmmoInWeapon(weaponHash: WeaponHash): number;
    getAmmoInClip(weaponHash: WeaponHash, ammo: number): number;
